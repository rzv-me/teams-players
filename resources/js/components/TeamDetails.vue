<template>
    <div class="w-1/3 bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div v-else class="p-4 flex items-center content-center">
            <div class="w-auto flex items-center content-center">
                <router-link :to="'/teams'" class="text-grey-light mr-4">
            ...
            <div class="w-auto flex-grow items-end text-right">
                <button class="rounded bg-green hover:bg-green-dark py-2 px-2 text-white font-normal" @click="showModal">Add Player</button>
            </div>
        </div>
        ...
        <portal to="modals">
            <transition name="fade">
                <div v-if="addingPlayer" class="fixed pin flex items-center z-10">
